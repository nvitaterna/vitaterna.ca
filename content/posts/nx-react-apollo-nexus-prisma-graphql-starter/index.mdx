...
This will create a new library in `libs/prisma-client`. Note that you will also have an `api-interfaces` library - try and do this now through the Nx cli:
...
Nx infers dependencies based on imports - while also letting you
